...
public class SunriseAndSunsetView extends View {
     ...
     * 日出日落实体类
     */
    private WeatherInfoResponse.Forecast15Bean mForecast15Bean;
    private float mPercent;

    private Resources mResources;

    public void setForecast15Bean(WeatherInfoResponse.Forecast15Bean forecast15Bean) {
        mForecast15Bean = forecast15Bean;
        mSunriseStr = forecast15Bean.getSunrise();
        mSunsetStr = forecast15Bean.getSunset();
    ...
    private void init() {
        ...
        mThemeColor = mResources.getColor(R.color.white);
        mThemeSubColor = mResources.getColor(R.color.white_3);
        ...
        mLeftAndRightPadding = mResources.getDimension(R.dimen.x32);
        mCircleRadius = mResources.getDimension(R.dimen.x16);
